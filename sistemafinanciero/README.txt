...
a persistence unit "sistemafinancieroPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sistemafinanciero\pom.xml":
...
artifact ("sistemafinanciero.war") is already built. You can build
