...
public class Transaccion implements Serializable{
	...
	/**
	 * Operacion de la transaccion deposito, retiro o transferencia.
	 */
	...
	/**
	 * Para numero de cedula, pasaporte del depositante o beneficiario.
	 */
	@Column(name = "tra_identificacion")
	private String identificacion;
	
	/**
	 * Para el nombre del depositante o beneficiario.
	 */
